 ...
 * @version: 
 * @Author: zhangguian
 * @Date: 2021-11-23 18:34:13
 * @LastEditors: zhangguian
 * @LastEditTime: 2021-12-01 10:08:41
-->
<template>
  <div>
    <Row :gutter="10">
        ...
        <div class="itera-list"> 
          <div class="itera-list-item" v-for="(item, index) in iteraList" :key="index">
            <div class="itera-list-item-head">
              ...
              <span style="flex:1; text-align: right;"><Tag color="green">{{item.status}}</Tag></span>
            </div>
      ...
      <div>
        <Tabs  v-model="tab">
            ...
            <div slot="extra" style="margin: 0px 10px;fontSize: 16px">
...
.itera-list-item:hover {
  // background-color: #eaf3fc;
  background-color: #f8f8f8;
}
.itera-list-item:active {
  background-color: #eaf3fc;
}
.add-alert-box {
  // padding: 20px; 
