 ...
 * @version: 
 * @Author: zhangguian
 * @Date: 2021-11-07 10:51:47
 * @LastEditors: zhangguian
 * @LastEditTime: 2021-11-07 14:07:43
-->
<template>
  <div>
              ...
              <table border="1" class="table">
                ...
                <tr>
                  ...
                  <td colspan="5">
                    <Row>
                      <Col :span="24">
                        <FormItem :prop="applyContent.applyType">
                          <RadioGroup v-model="applyContent.applyType" >
                              <Radio  style="margin-right: 10px;" v-for="item in aleaveType" :key="item.label" :label="item.label">{{item.type}}</Radio>
                          </RadioGroup>
                        </FormItem>
                      </Col>
                    </Row>
                ...
                <tr>
                  <td class="firstTr">出行方式</td>
                  <td colspan="2">
                    <Row>
                      <Col :span="24">
                        <FormItem :prop="applyContent.pay">
                          <Input v-model="applyContent.pay" :border="false" />
                        </FormItem>
                      </Col>
                    </Row>
                  </td>
                    ...
                    <Row>
                      <Col >
                        <FormItem :prop="applyContent.amount">
                          <Input v-model="applyContent.amount" :border="false" />
                        </FormItem>
                      </Col>
                    </Row>
                  </td>
                ...
                <tr>
                  <td colspan="6">
                    <Row>
                      <Col :xs="24" :sm="21">
                        <FormItem label="出行路线:" :label-width="100"  :prop="applyContent.route">
