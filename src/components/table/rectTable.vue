          ...
          <div class="pro-item" @click="() => handlePro(item)">
            <div class="pro-title">
              ...
              <div style="display: flex;align-items: center;justify-content: center;">
                ...
                <Tag :color="colorType(item.status)">{{$tools.changeShow(item.status, $c.proStatus)}}</Tag>
              </div>
                </Tooltip>
                ...
                <Dropdown @on-click="operate(item, $event)" :stop-propagation="true">
                  ...
                  <DropdownMenu slot="list" style="display: flex;justify-content: space-around;">
                    <Tooltip content="删除" placement="bottom">
                        <DropdownItem name="dele"><Icon type="md-trash" :size="20"/></DropdownItem>
                    </Tooltip>
                    <Tooltip content="编辑" placement="bottom">
                      <DropdownItem name="editor"><Icon type="ios-create" :size="20"/></DropdownItem>
                    </Tooltip>
                  </DropdownMenu>
                </Dropdown>
              </div>
            ...
            <div class="pro-publish">
              <a href="#" style="color: rgba(0, 0, 0, 0.45);" ><span>{{item.creator}}</span></a>
